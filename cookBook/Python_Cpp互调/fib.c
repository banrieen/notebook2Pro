 ...
 *     a, b = 0, 1
 */
  __pyx_t_1 = __Pyx_CyFunction_NewEx(&__pyx_mdef_3fib_1fib, 0, __pyx_n_s_fib, NULL, __pyx_n_s_fib, __pyx_d, ((PyObject *)__pyx_codeobj__3)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
